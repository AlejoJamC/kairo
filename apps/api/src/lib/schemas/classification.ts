import { z } from "zod";
import { ClassificationSchema, TICKET_TYPE, PRIORITY, CATEGORY, TONE } from "@kairo/intelligence";
...
export const CorrectClassificationSchema = z.object({
  correct_ticket_type: z.enum(TICKET_TYPE).optional(),
  correct_priority:    z.enum(PRIORITY).optional(),
  correct_category:    z.enum(CATEGORY).optional(),
  correct_sentiment:   z.enum(TONE).optional(),
