export const en = {
  ...
  wizard: {
    ...
    detect: {
      loadingDescription: "Processing the last 30 days. You can adjust the range later.",
      metricTickets: "Tickets",
      metricThreads: "Unique threads",
      metricClients: "Clients",
      metricCategories: "DETECTED CATEGORIES",
      categoryTechnical: "Technical",
      categoryBilling: "Billing",
      categoryAccount: "Account",
      categoryGeneral: "General",
      categoryNotApplicable: "Not applicable",
      errorTitle: "Could not load pipeline data.",
      errorBody: "The classification is still running in the background. You can continue anyway.",
      retry: "Retry",
      skip: "Skip",
      continue: "Continue",
      configureTriageDisabled: "Configure triage",
    },
